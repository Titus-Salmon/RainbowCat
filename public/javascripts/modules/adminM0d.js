...
if (userEml !== 'tsalm0n@twc.com') { //TODO should probably include emails as .env variables
...
if (userEml !== 'tsalm0n@twc.com' && userEml !== 'andrea@notrealemail.com') { //TODO should probably include emails as .env variables
